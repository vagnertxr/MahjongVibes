...
const I18N = {
  en: {
    ...
    callPon: "{player} {callVerb} Pon on {tile}.",
    callChi: "{player} {callVerb} Chi.",
    callKan: "{player} {callVerb} Kan on {tile}.",
    ...
    declareRiichi: "{player} {declareVerb} Riichi.",
    declareKan: "{player} {declareVerb} Kan on {tile}.",
    suits: {
      m: "Characters / Manzu",
      p: "Circles / Pinzu",
      s: "Bamboo / Souzu"
